...
class PROPHET_FOCUS(models.Model):
    ...
    body = RichTextField()
    book = RichTextField(verbose_name='BOOKS of THE Month')
...
class Testimony(models.Model):
    ...
    t_body = RichTextField(verbose_name="Testimony")
...
class CA(models.Model):
    scr = RichTextField(verbose_name='SCRIPTURE')
